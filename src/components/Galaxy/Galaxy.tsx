...
export function Galaxy({
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      if (ctn.contains(gl.canvas as HTMLCanvasElement)) ctn.removeChild(gl.canvas as HTMLCanvasElement)
      ...
      rotationSpeed, repulsionStrength, autoCenterRepulsion, transparent]) // eslint-disable-line react-hooks/exhaustive-deps
